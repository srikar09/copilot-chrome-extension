...
import { Chat, ContextTypes, transformBaseFinancialContext, transformBaseFinancialProfile } from "src/components/chat";
...
import { BankAccount, InvestmentAccount, MortgageAccount, RefinedCreditAccount, RefinedInvestmentAccount, RefinedLink, StudentLoanAccount } from "src/types/financials/message_financial_service";
...
const ChatPage: React.FC = () => {
  ...
  const investmentAccounts = financialProfile.link.reduce<RefinedInvestmentAccount[]>(
    (acc, link) => {
  ...
  */
  ...
  financialProfile.link.reduce((acc: MortgageAccount[], current: RefinedLink) => {
  ...
  financialProfile.link.reduce((acc: StudentLoanAccount[], current: RefinedLink) => {
